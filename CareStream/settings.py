"""
Django settings for CareStream project.
...
SECRET_KEY = 'django-insecure-hsl*q=0^c#_58397-@t2_n3s5=l*@kr5o(q58rvk1d#%xt)k9y'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
CSRF_TRUSTED_ORIGINS = ['https://care-stream-api.onrender.com','https://*.127.0.0.1']
...
WSGI_APPLICATION = 'CareStream.wsgi.application'
